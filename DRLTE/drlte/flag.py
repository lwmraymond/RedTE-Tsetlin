...
flags.DEFINE_integer('tm_circle', 10, 'tm circle len')
flags.DEFINE_integer('len_circle', 100, 'circle times each tm period')
...
# hesy add
flags.DEFINE_string('lpPerformFile', 'lpRes', 'the path of conrtained LP result of same TMs')
